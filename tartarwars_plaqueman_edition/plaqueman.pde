class plaqueman {
  ...
  plaqueman(float _x, float _y) {
    ...
    gr = new GhostR(red, 180, 110, 230);

    go = new GhostO(orange, 390, 100, 290);

    gb = new GhostB(blue, 205, 50, 290);
  }
  ...
  void draw() {
    ...
    if (dist(x, y, gr.x, gr.y)<radius+30)
    {
      DOH.pause();
      DOH.rewind();
      DOH.play();
    ...
    if (dist(x, y, gb.x, gb.y)<radius+30)
    {
      DOH.pause();
      DOH.rewind();
      DOH.play();
    ...
    if (dist(x, y, go.x, go.y)<radius+30)
    {
      DOH.pause();
      DOH.rewind();
      DOH.play();
