...
void drawSCOREShighestScores()
{
  ...
  if (mouseX >= margin && mouseX <= width - margin)
  {
    ...
    fill(255);
    textSize(15);
    text("Year: " + data.get(i).year, mouseX+20, y);
    text("HIGHEST_SCORES: " + data.get(i).highestScores, mouseX+20, y + 30);
    text("Player ID " + data.get(i).highestScores, mouseX+20, y + 50);
  }
}