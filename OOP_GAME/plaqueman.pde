...
class plaqueman {
  ...
  ArrayList<GhostR> ghostsR = new ArrayList();
   ArrayList<GhostB> ghostsB = new ArrayList();
    ArrayList<GhostO> ghostsO = new ArrayList();
  Minim minim1;
  ...
  plaqueman(float _x, float _y) {
    ...
    for (int g=0; g<1; g++)
    {
      ...
      GhostR ghostR = new GhostR((int(30)), (int)(40));
